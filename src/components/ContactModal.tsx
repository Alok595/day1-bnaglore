  ...
  return (
    ...
    >
      ...
      >
        ...
        <h3 id="contactModalTitle" className="contact-modal-title">
        ...
        <div className="contact-modal-list">
          ...
          <div className="contact-person">
            <div style={{ display: "flex", alignItems: "center", gap: "0.85rem" }}>
              ...
              <div className="contact-person-info">
                <span className="contact-person-name">Alex Morgan</span>
                <span className="contact-person-role">Founder &amp; Engineering Lead</span>
              </div>
            </div>
            <div className="contact-person-actions">
              <a
                href="https://wa.me/?text=Hi%20Alex%2C%20I'd%20like%20to%20discuss%20a%20project%20with%20Day%20One."
                target="_blank"
                rel="noopener noreferrer"
                className="contact-action contact-action--whatsapp"
                aria-label="WhatsApp Alex Morgan"
              >
                <svg
                  width="16"
                  height="16"
          ...
          <div className="contact-person">
            <div style={{ display: "flex", alignItems: "center", gap: "0.85rem" }}>
              ...
              <div className="contact-person-info">
                <span className="contact-person-name">Sarah Chen</span>
                <span className="contact-person-role">Co-Founder &amp; Design Director</span>
              </div>
            </div>
            <div className="contact-person-actions">
              <a
                href="https://wa.me/?text=Hi%20Sarah%2C%20I'd%20like%20to%20discuss%20a%20project%20with%20Day%20One."
                target="_blank"
                rel="noopener noreferrer"
                className="contact-action contact-action--whatsapp"
                aria-label="WhatsApp Sarah Chen"
              >
                <svg
                  width="16"
                  height="16"
